...
export default function Home() {
  ...
  return (
    <main className="relative min-h-[100dvh] w-full bg-[radial-gradient(circle_at_top_left,#fffdfa_0%,#f7f3ed_100%)] text-[#2d2a26] overflow-x-hidden">
      ...
      <AnimatePresence mode="wait">
        {!isOpen ? (
          ...
          <motion.div
            ...
            className="w-full min-h-[100dvh] flex flex-col lg:flex-row relative z-10"
          >
            {/* Left sidebar */}
            <div className="w-full lg:w-[420px] shrink-0 flex flex-col p-8 lg:p-12 justify-between border-b lg:border-b-0 lg:border-r border-[#e8e2d8] z-20 lg:h-[100dvh] lg:sticky lg:top-0 bg-[radial-gradient(circle_at_top_left,#fffdfa_0%,#f7f3ed_100%)]">
              <div className="space-y-1 text-center lg:text-left mb-12 lg:mb-0">
                ...
                <p className="text-sm opacity-60 mt-2">Parceria que atravessa o tempo.</p>
              </div>

              {/* Photos */}
              <div className="relative flex items-center justify-center py-10 my-auto lg:my-0">
                <div className="rotate-3 bg-white p-3 pb-10 w-64 h-80 border border-[#e5e0d8] shadow-xl relative z-10 transition-transform duration-300 hover:scale-[1.02]">
                  ...
                  <div className="absolute bottom-3 left-0 w-full text-center">
                     <span className="text-[#9a9489] text-[11px] font-playfair italic">
                       {showAdultPhoto ? "[ Foto Atual ]" : "[ Foto de Infância ]"}
                     </span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 bg-white relative lg:shadow-2xl z-10 lg:h-[100dvh] lg:overflow-y-auto">
              {/* Background L */}
              ...
              >
                <div className="flex-1 lg:pr-4">
                  ...
                  <div className="font-playfair text-[#4a453e] text-[16px] md:text-[18px] leading-[1.8] space-y-6 text-justify">
                    <p>Hoje o dia é todo seu! Mais do que primos, a vida fez da gente a melhor dupla. É aquilo que a gente vive na prática desde sempre: eu por você e você por mim, não importa a situação.</p>
                    
                    <p>Nossa parceria vem de longe. Lembro perfeitamente de quando éramos crianças, brincando na sala da tia: você focado nos seus desenhos e eu fazendo meus origamis. Ou de quando o tio colocava Victor e Leo pra tocar e a gente cantava com toda a vontade, imaginando que éramos a própria dupla.</p>
                    
                    <p>O tempo passou, a gente cresceu, mas a sintonia continua a mesma. Só mudou o cenário: das brincadeiras na sala, passamos a cantar alto nos shows reais e a aproveitar cada segundo daquelas nossas viagens em família, que sempre rendem as memórias mais inesquecíveis. Quando paro para pensar nas melhores histórias da minha vida, você está em todas elas.</p>

                    <p>Sou muito grato por você topar viver a energia dos rodeios comigo. E já que estamos falando nisso, saber que você vai estar do meu lado para realizar meus dois maiores sonhos – conhecer o Barretão e assistir ao show de Chitãozinho e Xororó – significa o mundo pra mim. Você vai viver isso ao meu lado, exatamente como sempre estivemos um para o outro a vida toda.</p>

                    <p>Hoje também é dia de te lembrar o quanto você é importante para mim. Admiro demais a pessoa genuína e bondosa que você é, além de ser um cara incrivelmente determinado e um verdadeiro guerreiro na vida.</p>

                    <p>Que a vida continue te dando saúde, sucesso e motivos para comemorar, porque de parceria para as próximas aventuras e para o Barretão você já sabe que tá garantido.</p>
                  </div>
                </div>
                ...
                <div className="mt-16 pt-8 border-t border-[#f0ede8] flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 sm:gap-0 pb-12 lg:pb-0">
                  <div className="font-playfair text-[#8b4513] italic opacity-80 text-xl font-medium max-w-[250px] leading-snug">
